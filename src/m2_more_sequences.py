...
def shortest_string(strings):
    ...
    # ------------------------------------------------------------------
    index_of_shortest_string = 0
    for k in range(1, len(strings)):
        if len(strings[k]) < len(strings[index_of_shortest_string]):
            index_of_shortest_string = k
    return strings[index_of_shortest_string]
...
def index_of_largest_number(numbers, n):
    ...
    for k in range(n):
        if numbers[index_of_largest_num] < numbers[k]:
...
def number_of_stutters(s):
    ...
    for k in range(len(s) - 1):
        if s[k] == s[k+1]:
            num_of_stutters = num_of_stutters + 1
    return num_of_stutters
...
def count_same(sequence1, sequence2):
    ...
    #     The testing code is already written for you (above).
    # ------------------------------------------------------------------
    number_of_same_items = 0
    for k in range(len(sequence1)):
        if sequence1[k] == sequence2[k]:
            number_of_same_items = number_of_same_items + 1
